...
@Component({
    selector: 'app-athlete-adrv',
    templateUrl: 'athlete-adrv.component.html',
})
export class AthleteADRVComponent implements OnInit {
    ...
    ngOnInit(): void {
        this.athleteId$
            ...
            .subscribe((id: string) => {
                this.store.dispatch(fromStore.InitADRVs({ athleteId: id }));
            });
    }
}
