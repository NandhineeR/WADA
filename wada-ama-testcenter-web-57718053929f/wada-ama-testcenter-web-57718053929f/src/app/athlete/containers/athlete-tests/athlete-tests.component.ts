...
@Component({
    selector: 'app-athlete-tests',
    templateUrl: 'athlete-tests.component.html',
})
export class AthleteTestsComponent implements OnInit {
    ...
    ngOnInit(): void {
        this.athleteId$
            ...
            .subscribe((id: string) => {
                this.store.dispatch(fromStore.InitAthleteTests({ athleteId: id }));
            });
    }
}
