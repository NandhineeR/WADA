import { Address, CountryWithRegions, Participant, Phone, SportDiscipline } from '@shared/models';
import { isNullOrBlank } from '@shared/utils/string-utils';

export class AthleteInformation {
    ...
    constructor(form?: Partial<AthleteInformation> | null) {
        const {
            accessible = null,
            adamsId = '',
            address = null,
